...
export const HUFF_MAIN_TOKENS: TokenType[] = [
    ...
    createToken({ name: "builtInFuncSig", pattern: /__FUNC_SIG\(.*\)/ }),
    createToken({ name: "builtInEventHash", pattern: /__EVENT_HASH\(.*\)/ }),
    createToken({ name: "builtInError", pattern: /__ERROR\(.*\)/ }),
    createToken({ name: "builtInRightPad", pattern: /__RIGHTPAD\(.*\)/ }),
    createToken({ name: "builtInCodesize", pattern: /__codesize\(.*\)/ }),
    createToken({ name: "builtInTablestart", pattern: /__tablestart\(.*\)/ }),
    createToken({ name: "builtInTablesize", pattern: /__tablesize\(.*\)/ }),
    /* ---------------------------- Huff definitions ---------------------------- */
